...
class DatabaseSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        DB::table('current_transactions')->insert([
            ['room_id' => 1, 'name' => 'Anisa Dewi', 'start_date' => '2024-02-18', 'end_date' => '2024-02-20'],
            ['room_id' => 1, 'name' => 'Rizky Pratama', 'start_date' => '2024-02-18', 'end_date' => '2024-02-21'],
            ['room_id' => 2, 'name' => 'Siti Nurul Hidayah', 'start_date' => '2024-02-18', 'end_date' => '2024-02-19'],
            ['room_id' => 2, 'name' => 'Faisal Akbar', 'start_date' => '2024-02-18', 'end_date' => '2024-02-20'],
            ['room_id' => 3, 'name' => 'Nia Fitriani', 'start_date' => '2024-02-19', 'end_date' => '2024-02-22'],
            ['room_id' => 3, 'name' => 'Reza Maulana', 'start_date' => '2024-02-19', 'end_date' => '2024-02-23'],
            ['room_id' => 4, 'name' => 'Putri Anggraini', 'start_date' => '2024-02-20', 'end_date' => '2024-02-22'],
            ['room_id' => 4, 'name' => 'Ilham Wibowo', 'start_date' => '2024-02-20', 'end_date' => '2024-02-23'],
            ['room_id' => 5, 'name' => 'Dina Permata', 'start_date' => '2024-02-21', 'end_date' => '2024-02-24'],
            ['room_id' => 5, 'name' => 'Bayu Santoso', 'start_date' => '2024-02-21', 'end_date' => '2024-02-25'],
            ['room_id' => 6, 'name' => 'Maya Puspita', 'start_date' => '2024-02-22', 'end_date' => '2024-02-24'],
            ['room_id' => 6, 'name' => 'Dedy Kurniawan', 'start_date' => '2024-02-22', 'end_date' => '2024-02-25'],
            ['room_id' => 7, 'name' => 'Ayu Lestari', 'start_date' => '2024-02-23', 'end_date' => '2024-02-26'],
            ['room_id' => 7, 'name' => 'Arif Hidayat', 'start_date' => '2024-02-23', 'end_date' => '2024-02-27'],
            ['room_id' => 8, 'name' => 'Rini Wahyuni', 'start_date' => '2024-02-24', 'end_date' => '2024-02-26'],
            ['room_id' => 8, 'name' => 'Andi Saputra', 'start_date' => '2024-02-24', 'end_date' => '2024-02-27'],
            ['room_id' => 9, 'name' => 'Santi Wahyuni', 'start_date' => '2024-02-25', 'end_date' => '2024-02-28'],
            ['room_id' => 9, 'name' => 'Aditya Nugraha', 'start_date' => '2024-02-25', 'end_date' => '2024-02-29'],
            ['room_id' => 10, 'name' => 'Yuni Susanti', 'start_date' => '2024-02-26', 'end_date' => '2024-02-28'],
            ...
            ['room_id' => 11, 'name' => 'Budi Santoso', 'start_date' => '2024-02-27', 'end_date' => '2024-03-02'],
            ['room_id' => 10, 'name' => 'Anita Fitri', 'start_date' => '2024-02-18', 'end_date' => '2024-02-20'],
            ['room_id' => 10, 'name' => 'Rudi Hermawan', 'start_date' => '2024-02-19', 'end_date' => '2024-02-21'],
            ['room_id' => 5, 'name' => 'Diana Sari', 'start_date' => '2024-02-20', 'end_date' => '2024-02-22'],
            ['room_id' => 4, 'name' => 'Irfan Setiawan', 'start_date' => '2024-02-21', 'end_date' => '2024-02-23'],
            ['room_id' => 7, 'name' => 'Linda Permadi', 'start_date' => '2024-02-22', 'end_date' => '2024-02-24'],
            ['room_id' => 6, 'name' => 'Robby Wijaya', 'start_date' => '2024-02-23', 'end_date' => '2024-02-25'],
            ['room_id' => 9, 'name' => 'Siska Agustiani', 'start_date' => '2024-02-24', 'end_date' => '2024-02-26'],
            ...
            ['room_id' => 1, 'name' => 'Yoga Pratama', 'start_date' => '2024-02-27', 'end_date' => '2024-02-29'],
        ]);
