...
<div class="w-full flex flex-col h-screen overflow-y-hidden">
    ...
    <div class="bg-white w-full overflow-x-hidden border-t flex flex-col max-sm:pt-20">
        <main class="w-full flex-grow p-6">
            ...
            <div class="container flex mx-auto flex-col mb-10">
                ...
                <div class="flex flex-wrap lg:flex-nowrap py-4 lg:gap-4 gap-2 grid grid-cols-10">
