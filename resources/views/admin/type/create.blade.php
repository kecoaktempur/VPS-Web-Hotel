                        ...
                        <div class="flex">
                            <div class="w-1/3 mb-2">
                                <div class="relative mb-2">
                                    ...
                                    <input type="text" id="name" name="name" class="block px-2.5 py-2.5 w-full text-sm text-gray-900 bg-transparent rounded-xl border-1 border-2 border-black appearance-none focus:outline-none focus:ring-0 focus:border-black peer bg-white" placeholder="Nama Ruangan" />
                                </div>
                                @if($errors->has('name'))
                            ...
                            <div class="w-1/3 pl-2 mb-2">
                                <div class="relative mb-2">
                                    ...
                                    <input type="number" id="size" name="size" class="block px-2.5 py-2.5 w-full text-sm text-gray-900 bg-transparent rounded-xl border-1 border-2 border-black appearance-none focus:outline-none focus:ring-0 focus:border-black peer bg-white" min="1" placeholder="Jumlah Orang" />
                                </div>
                                @if($errors->has('size'))
                                <div class="text-red-500 text-sm mt-1">
                                    {{ $errors->first('size') }}
                            ...
                            <div class="w-1/3 pl-2 mb-2">
                                <div class="relative mb-2">
                                    ...
                                    <input type="number" id="price" name="price" class="block px-2.5 py-2.5 w-full text-sm text-gray-900 bg-transparent rounded-xl border-1 border-2 border-black appearance-none focus:outline-none focus:ring-0 focus:border-black peer bg-white" min="0" placeholder="Harga" />
                                </div>
                                @if($errors->has('price'))
                                <div class="text-red-500 text-sm mt-1">
                                    {{ $errors->first('price') }}
                        ...
                        <div class="flex">
                            <div class="w-full pl-2 mb-2">
                                ...
                                <div class="py-2 px-4 mb-4 rounded-lg rounded-t-lg border border-gray-200">
                                    ...
                                    <textarea id="description" name="description" rows="6" class="bg-transparent px-0 w-full text-sm text-gray-900 border-0 focus:ring-0 focus:outline-none" placeholder="Kamar standar kami ....."></textarea>
                                </div>
