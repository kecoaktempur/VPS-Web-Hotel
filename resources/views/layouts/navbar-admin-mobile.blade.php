<nav class='fixed inset-x-0 top-0 mx-auto w-full border border-gray-100 bg-white/80 py-3 shadow backdrop-blur-lg md:top-6 md:rounded-xl md:w-5/6 font-[Montserrat] z-20 sm:hidden'>
    <div class='flex flex-wrap justify-between px-10 py-3'>
        ...
        <ul id="collapseMenu" class='lg:!flex lg:space-x-10 max-lg:hidden max-lg:w-full max-lg:my-2'>
