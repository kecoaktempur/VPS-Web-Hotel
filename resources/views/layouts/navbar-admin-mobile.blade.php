<header x-data="{ isOpen: false }" class="w-full bg-sidebar py-5 px-6 sm:hidden">
    <div class="flex items-center justify-between">
        <a href="index.html" class="text-[#12182E] text-3xl font-semibold uppercase hover:text-gray-300">Admin</a>
        <button @click="isOpen = !isOpen" class="text-[#12182E] text-3xl focus:outline-none">
    ...
    <nav :class="isOpen ? 'flex': 'hidden'" class="flex flex-col pt-4">
        ...
        <form action="{{ route('logout') }}" class="flex justify-center py-4 pl-6 text-black hover:bg-red-600 group {{ Str::contains(Route::currentRouteName(), 'dashboard') ? 'bg-red-600' : '' }}" method="POST">
            @csrf
