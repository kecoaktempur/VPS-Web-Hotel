<aside class="relative bg-white h-screen w-64 hidden sm:block shadow-xl" id="asideNavbar">
    <button data-drawer-target="logo-sidebar" data-drawer-toggle="logo-sidebar" aria-controls="logo-sidebar" type="button" class="flex justify-center px-3 py-4 text-white max-sm:hidden" id="openSidebarMini">
        <span class="sr-only">Open sidebar</span>
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-8 h-8 text-black hover:text-red-600">
            <path stroke-linecap="round" stroke-linejoin="round" d="M3.75 6.75h16.5M3.75 12h16.5m-16.5 5.25h16.5" />
        </svg>
    </button>
    <div class="p-6">
        <a href="index.html" class="text-white text-3xl font-semibold uppercase hover:text-gray-300" id="textSidebarMini">Admin</a>
    </div>
    <nav class="text-white text-base font-semibold pt-3">
        <a href="{{ route('dashboard') }}" class="flex justify-center py-4 pl-6 text-black hover:bg-red-600 group {{ Str::contains(Route::currentRouteName(), 'dashboard') ? 'bg-red-600' : '' }}" id="navLink">
            ...
            <span class="flex-1 ms-3 whitespace-nowrap" id="textSidebarMini">Dashboard</span>
        </a>
        <a href="{{ route('transaction.index.current') }}" class="flex justify-center py-4 pl-6 text-black hover:bg-red-600 group {{ Str::contains(Route::currentRouteName(), 'current') ? 'bg-red-600' : '' }}" id="navLink">
            <svg xmlns="http://www.w3.org/2000/svg" class="flex-shrink-0 w-5 h-5 text-black transition duration-75 group-hover:text-white {{ Str::contains(Route::currentRouteName(), 'current') ? 'text-white' : '' }}" viewBox="0 0 24 24">
                <g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2">
                    <path d="M10 6a7.5 7.5 0 1 0 8 8h-8z" />
                    <path d="M13.5 3H13v8h8v-.5A7.5 7.5 0 0 0 13.5 3" />
                </g>
            </svg>
            <span class="flex-1 ms-3 whitespace-nowrap" id="textSidebarMini">Transaksi Baru</span>
        </a>
        <a href="{{ route('transaction.index.past') }}" class="flex justify-center py-4 pl-6 text-black hover:bg-red-600 group {{ Str::contains(Route::currentRouteName(), 'past') ? 'bg-red-600' : '' }}" id="navLink">
            ...
            <span class="flex-1 ms-3 whitespace-nowrap" id="textSidebarMini">Transaksi Lama</span>
        </a>
        <a href="{{ route('notif') }}" class="flex justify-center py-4 pl-6 text-black hover:bg-red-600 group {{ Str::contains(Route::currentRouteName(), 'notif') ? 'bg-red-600' : '' }}" id="navLink">
            ...
            <span class="flex-1 ms-3 whitespace-nowrap" id="textSidebarMini">Notifikasi</span>
            @php
        ...
        <a href="{{ route('type.index.admin') }}" class="flex justify-center py-4 pl-6 text-black hover:bg-red-600 group {{ Str::contains(Route::currentRouteName(), 'type') ? 'bg-red-600' : '' }}" id="navLink">
            ...
            <span class="flex-1 ms-3 whitespace-nowrap text-black" id="textSidebarMini">Tipe
                Ruangan</span>
        </a>
        <a href="{{ route('room') }}" class="flex justify-center py-4 pl-6 text-black hover:bg-red-600 group {{ Str::contains(Route::currentRouteName(), 'room') ? 'bg-red-600' : '' }}" id="navLink">
            ...
            <span class="flex-1 ms-3 whitespace-nowrap" id="textSidebarMini">Ruangan</span>
        </a>
        <a href="{{ route('photo') }}" class="flex justify-center py-4 pl-6 text-black hover:bg-red-600 group {{ Str::contains(Route::currentRouteName(), 'photo') ? 'bg-red-600' : '' }}" id="navLink">
            ...
            <span class="flex-1 ms-3 whitespace-nowrap" id="textSidebarMini">Foto</span>
        </a>
        <a href="{{ route('review') }}" class="flex justify-center py-4 pl-6 text-black hover:bg-red-600 group {{ Str::contains(Route::currentRouteName(), 'review') ? 'bg-red-600' : '' }}" id="navLink">
            ...
            <span class="flex-1 ms-3 whitespace-nowrap" id="textSidebarMini">Review</span>
        </a>
    </nav>
    <form action="{{ route('logout') }}" class="absolute w-full bottom-0 flex items-center justify-center py-4 pl-6" method="POST">
        @csrf
        ...
        <button type="submit">
            <span class="flex-1 ms-3 whitespace-nowrap" id="textSidebarMini">Log Out</span>
        </button>
    </form>
</aside>
